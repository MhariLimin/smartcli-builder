  ...
  return (
    <header className="sticky top-0 z-30 flex h-11 items-center justify-between gap-2 border-b border-slate-200 bg-white/95 px-3 backdrop-blur-xl dark:border-navy-800 dark:bg-navy-950/95">
      <div className="flex min-w-0 items-center gap-2">
        ...
        <img src="/brand/smartcli-wordmark-light.svg" alt="SmartCLI" className="h-7 w-[112px] object-contain object-left dark:hidden lg:hidden" />
        <img src="/brand/smartcli-wordmark.svg" alt="" className="hidden h-7 w-[112px] object-contain object-left dark:block lg:dark:hidden" />
        <button
          onClick={openPalette}
